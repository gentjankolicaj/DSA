...
public class Philosopher implements Runnable, Human {
  ...
  public void run() {
    ...
    while (!isFull) {
      ...
      try {
        ...
        if (acquiredLeft && acquiredRight) {
          ...
          log.warn("Thread {} couldn't acquire both chopsticks.Left {} , right {}", Thread.currentThread(),
    ...
    log.info("Thread {} terminating , philosopher {} is full {}", Thread.currentThread(),id,isFull());
  }
